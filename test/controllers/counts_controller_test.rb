...
class CountsControllerTest < ActionController::TestCase
  ...
  test "should create count" do
    assert_difference('Count.count') do
      post :create, count: { count: @count.count, description: @count.description, goal: @count.goal, name: @count.name }
    end
  ...
  test "should update count" do
    patch :update, id: @count, count: { count: @count.count, description: @count.description, goal: @count.goal, name: @count.name }
    assert_redirected_to count_path(assigns(:count))
  end
